    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin principal'), ('seller', 'Vendeur')], default='seller', max_length=10, verbose_name='Rôle')),
                ('boutique', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='core.boutique', verbose_name='Boutique assignée')),
